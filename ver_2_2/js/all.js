...
//NOTE: Giá tiền random trong hàng chục. [.000.000đ] là dạng Chuỗi 
//------------------------KHỞI TẠO HOÀN TẤT--------------------------
                ...
                <div class="cart-item" id="' + box_index + '">\
                    ...
                    <div class="cart-item-right">\
                        <form action="">\
                            ...
                            <input onclick="alert(\'Thêm thành công\')" type="button" name="" value="OK">\
                        </form>\
                    </div>\
...
/**
 * Sự kiện nhấn nút xoá sản phẩm trong trang Giỏ Hàng 
 */
...
/**
 * Load nội dung trang Thông tin chi tiết sản phẩm
 */
...
/**
 * Gán giá trị cho nút [Thêm sản phẩm]
 * [thứ tự danh mục] && [Thứ tự sản phẩm]
 */
...
/**
 * Load trang tìm kiếm sản phẩm
 */
function load_tim_kiem() {
    //Load lại nội dung search từ url xuống form
    search_selected();
    //Lướt trang xuống phần nội dung
    go_to_content();
 ...
 * @param  {number} n [Vị trí bắt đầu để hiện sản phẩm]
 */
...
//Load lại những lựa chọn đã chọn trong lần search trước
...
//Kiểm tra trạng thái tài khoản có được đăng nhập hay ko
//Nếu có thì load giao diện đã đăng nhập
//
...
//Sửa vụ chữ bị tràn ra khỏi khung
